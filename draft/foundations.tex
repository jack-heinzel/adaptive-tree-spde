...
This is a major result, and unlocks the computation power of SPDEs while preserving the intuitive structure and power of traditional GP methods. We will attempt to leverage these SPDE approaches for inference on fields (specifically, Poisson intensity functions). 
